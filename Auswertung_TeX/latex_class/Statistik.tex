...
\end{flalign}
\paragraph{Tabellenerstellung, Plots:} Im \secref{sec:python_tabelle} findet sich eine Datei zur Erstellung der Vergleichstabellen, in denen die obigen Ergebnisgrößen automatisch berechnet werden. Zudem ist in \secref{sec:python_plots} eine Datei angehängt, in der die Plots generiert werden.
\newpage
