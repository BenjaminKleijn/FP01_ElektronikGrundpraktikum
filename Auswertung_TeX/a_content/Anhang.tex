...
\begin{flalign*}
  ...
  &\hspace*{1.5cm} f_{ug}=(2\pi\cdot R_{\text{EIN}} \cdot C_{\text{EIN}})^{-1} &&&& =\qty{37.40}{\hertz} \tag{1}
...
\begin{flalign*}
  ...
  \intertext{erneutes Berechnen der unteren Grenzfrequenz mit neu gewählter Kapazität:}
  &\hspace*{1.5cm} f_{ug}=(2\pi\cdot R_{\text{EIN}}\cdot C_{\text{EIN}})^{-1}&&&&=\qty{49.10}{\hertz} \tag{2} \label{eq:f_ug_theo_kollektor}
\end{flalign*}
