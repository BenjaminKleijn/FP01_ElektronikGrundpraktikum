...
\begin{document}
    ...
    \listoftables
    \clearpage                    
    \section{Motivation}                                % Die Texte werden in den einzelnen Dateien eingefügt.
